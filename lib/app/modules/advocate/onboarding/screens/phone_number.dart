...
class PhoneNumberAdvocateScreen extends StatelessWidget {
  const PhoneNumberAdvocateScreen({super.key});
          ...
          child: ButtonDefaultShared(
            onTap: () {
              Modular.to.pushNamed(
                  OnboardingAdvocateModule.route + AccountAdvocateScreen.route.substring(1));
            },
            title: "Next",
          ),
        ),
